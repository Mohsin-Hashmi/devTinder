  ...
  return (
    <>
      <div className="w-[1170px] flex items-center justify-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <form onSubmit={handleSignup} className="p-[50px] m-auto w-1/2 border border-white rounded-3xl shadow-[0_15px_15px_rgba(255,255,255,0.3)]">
          ...
          <svg
            ...
            <input type="text" className="grow" value={firstName} onChange={(e)=>setFirstName(e.target.value)} placeholder="First Name" required/>
          </label>
          ...
          <label className="input input-bordered flex items-center gap-2 mb-[18px]">
            ...
            <input type="text" className="grow" value={lastName} onChange={(e)=>setLastName(e.target.value)} placeholder="Last Name" required/>
          </label>
          ...
          <label className="input input-bordered flex items-center gap-2 mb-[18px]">
            ...
            <input type="text" className="grow" value={emailId} onChange={(e)=>setEmailId(e.target.value)} placeholder="Email" required/>
          </label>
          ...
          <label className="input input-bordered flex items-center gap-2">
            ...
            <input type={showPassword ? "text" : "password"} value= {password} onChange={(e)=>setPassword(e.target.value)} className="grow" placeholder="Password" required/>
            <input type="checkbox" checked={showPassword} onClick={handleshowPassword}/>
          </label>
